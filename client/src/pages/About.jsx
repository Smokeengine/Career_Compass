...
const About = () => {
  return (
    <div className='container mx-auto flex flex-col gap-8 2xl:gap-14 py-6  bg-Harry rounded-lg m-5'>
      <div className='w-full flex flex-col-reverse md:flex-row gap-10 items-center p-5  '>
        ...
        <img src={JobImg} alt='About' className='w-auto h-[300px] rounded-lg' />
      </div>
