...
const JobDetail = () => {
  ...
  const handleApply =  () => {
    ...
    const conf = window.confirm("Confirm Apply to Job Post?");
  ...
  return (
    <div className='container mx-auto bg-Harry rounded-lg m-8'>
      <div className='w-full flex flex-col md:flex-row gap-10 '>
        {/* LEFT SIDE */}
        {isFetching ? (
          <Loading />
        ) : (
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md md:m-6  rounded-lg'>
            ...
            {selected === "0" ? (
              <>
                ...
                {job?.detail[0]?.requirements && (
                  <>
                    <p className='text-xl font-semibold mt-8'>Requirement's:</p>
