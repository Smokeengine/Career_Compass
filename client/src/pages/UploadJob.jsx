...
const UploadJob = () => {
  ...
  return (
    <div className='container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-Harry px-5 mt-5 rounded-lg mb-6'>
      <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-[#f7fdfd] px-5 py-10 md:px-10 shadow-md mt-6 rounded-lg'>
        <div>
